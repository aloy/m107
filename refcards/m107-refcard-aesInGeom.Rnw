...
\chead{\sf \bfseries \Large R Graphics for Intro Stats}
\lhead{Math 107}
\rhead{Spring 2016}
...
<<>>=
ggplot(data = data_set) + 
  geom_histogram(mapping = aes(x = variable), binwidth = w, 
                 colour = "gray20") + 
  xlab("Variable name")
@
\squeeze
...
<<>>=
ggplot(data = data_set) +
  geom_boxplot(mapping = aes("var", variable)) +
  xlab("") + 
  ylab("Variable name")
...
<<>>=
ggplot(data = data_set) +
  geom_boxplot(mapping = aes(x = group, y = variable)) + 
  xlab("Group") +
  xlab("Variable name") 
@
\squeeze
...
<<>>=
ggplot(data = data_set) +
  geom_point(mapping = aes(x = xvariable, y = yvariable)) +
  xlab("x-axis label") + 
  ylab("y-axis label")
@
\squeeze
...
ggplot(data = data_set) +
  geom_point(mapping = aes(x = xvariable, y = yvariable)) +
  geom_smooth(mapping = aes(x = xvariable, y = yvariable), method = "lm") +
  xlab("x-axis label") + 
  ylab("y-axis label")
@

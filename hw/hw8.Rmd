...
Use R to find the following $z^*$ values based on a standard normal distribution.

a. An 84% confidence interval.
b. A 92% confidence interval.
c. A 96% confidence interval.
d. A 75% confidence interval.
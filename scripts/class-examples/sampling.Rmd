...
3. Use the `sample_n` function to draw a simple random sample of size $n$ rows from a data set.
```{r}
...
6. Let's compare your sample statistics to the population parameters.
    ...
    b. How many and what proportion of students in your class obtained a sample proportion of e-words larger than the population proportion (0.47)?

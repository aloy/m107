...
Alternatively, we can use the `permTest` function in R carryout the entire permutation test. Note that the below code prints the results of the test on the screen and also produces a histgoram of the permutation distribution. `permTest` requires the following arguments:
...
**Question 11.** If the results are statistically significant, what does this indicate about beer's impact on moquito attractiveness?
